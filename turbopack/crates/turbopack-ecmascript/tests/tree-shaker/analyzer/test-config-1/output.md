...
export { upper as c } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { internal as d } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { external1 as e } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { external2 as f } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { foo };
const foo = foobar;
export { foo as g } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
